...
Version 1 uses the UKRI Funding Finder RSS feed. The code is structured so additional sources such as Innovate UK, EU Funding & Tenders, charity funders, university pages, or permitted Research Professional feeds can be added later.
...
- fetch the UKRI Funding Finder RSS feed
